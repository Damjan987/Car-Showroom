...
<body>
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        <li class="active"><a href="http://localhost:8084/spring-security-custom-user-registration-demo/">Home</a></li>
  ...
  <div style="width:20%; margin-left:50px">
      ...
      <form:form action="updateCar" modelAttribute="car" method="POST">
        <form:hidden path="id" />
